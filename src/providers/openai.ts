...
/** Default model id. */
export const OPENAI_MODEL = process.env.OPENAI_MODEL ?? 'qwen2.5';

/**
 * Model catalog.
 *
 * One entry is enough for the demo; add rows for whatever your endpoint serves.
 * Costs/limits below are illustrative.
 */
export const OPENAI_MODELS: ModelInfo[] = [
  {
    ...
    costPer1MOutput: 0,
    tier: 'balanced',
    description: 'OpenAI-compatible chat model (local or remote).',
  },
];
