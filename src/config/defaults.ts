...
export function applySessionDefaults(
  ...
  return applyDefaults(config, defaults as Record<string, unknown>) as SessionConfig;
}
...
export function applyQueueDefaults(
  ...
  return applyDefaults(config, defaults as Record<string, unknown>) as QueueConfig;
}
...
export function applyTypingDefaults(
  ...
  return applyDefaults(config, defaults as Record<string, unknown>) as TypingConfig;
}
...
export function applyBlockReplyDefaults(
  ...
  return applyDefaults(config, defaults as Record<string, unknown>) as BlockReplyConfig;
}
...
export function applyErrorRecoveryDefaults(
  ...
  return applyDefaults(config, defaults as Record<string, unknown>) as ErrorRecoveryConfig;
}
